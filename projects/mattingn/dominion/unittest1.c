...
int main()
{
    ...
    //UNIT TEST FOR ADVENTURER CARD: CHECK TO SEE IF +1 ACTION WAS ADDED 
	if(testG.numActions+2 == G.numActions)
		printf("PASSED. 2 ACTIONS WERE ADDED\n");
	else
		printf("FAILED. 2 ACTIONS WERE NOT ADDED\n");
